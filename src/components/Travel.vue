<template>
  <div class="view-header hello">
    ...
    <div class="container-text-font">
      ...
      <div class="container-text-font">
          <h1>Directions from BWI to Double Tree Hotel:</h1>
          <p>
            By I-97:
     ...
     <div class="container-text-font">
          <h1>Directions from Dulles to Double Tree Hotel:</h1>
          <p></p>
    </div>
     <div class="container-text-font">
     ...
     <div class="container-text-font">
          <h1>Directions from BWI to Quiet Water Park:</h1>
    </div>
     <div class="container-text-font">
          <h1>Directions from Dulles to Quiet Water Park:</h1>
    </div>
  </div>
</template>
